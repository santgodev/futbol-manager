          ...
          matches.map((m) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-1 justify-end">
                ...
                <div className="w-5 h-5 rounded bg-brand-navy border border-brand-cyan/20 flex items-center justify-center shrink-0 overflow-hidden">
                  {m.home_team?.logo_url ? (
                    <Image src={m.home_team.logo_url} alt="Local" width={20} height={20} className="object-cover" unoptimized />
                  ) : <Shield size={10} className="text-brand-cyan/50" />}
                </div>
              </div>
              ...
              <div className="px-3 flex flex-col items-center justify-center">
                ...
                <span className="text-[10px] font-black text-brand-yellow font-mono px-2 py-0.5 bg-brand-yellow/10 rounded">
